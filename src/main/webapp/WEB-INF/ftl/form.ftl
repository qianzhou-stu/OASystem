    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layui-col-space5">
                ...
                <input id="startTime" name="startTime" type="hidden" autocomplete="off">
                <input id="endTime" name="endTime" type="hidden" autocomplete="off">
            </div>
        </div>
...
<script src="/oa/resources/sweetalert2.all.min.js"></script>
...
<script>
    ...
    layForm.on('submit(sub)', function (data) {
        ...
        $.post("/oa/leave/create", data.field, function (json) {
            console.info(json);
            if (json.code === 1000) {
                /*SweetAlert2确定对话框*/
                swal({
                    ...
                    window.location.href = "/oa/forward/notice";
                });
            } else {
                swal({
                    type: 'warning',
